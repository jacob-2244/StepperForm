            ...
            case 0:
                return (
                    <section className="flex flex-col gap-2">
                        <h2 className="w-full text-2xl font-bold mb-2 text-app_primary">SERVICE INFORMATION</h2>
                ...
                {errors.city && <p className="text-red-500 text-sm">{errors.city.message}</p>}
                            ...
                            <div className="flex-1 flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className={`w-full border px-2 py-4 rounded ${errors.state ? "border-red-500" : ""}`}
                                />
                            ...
                            <div className="flex-1 flex flex-col gap-2 w-full">
                                ...
                                <input
                                    ...
                                    className={`w-full border px-2 py-4 rounded ${errors.zip ? "border-red-500" : ""}`}
                                />

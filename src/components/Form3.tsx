...
// import OpenStreetMap2 from '@/components/OpenStreetMap'
...
//   // Function to construct full address for map
//   const getFullAddress = () => {
//     const direction1 = watch("direction1") || "";
//     const addressNumber = watch("addressNumber") || "";
//     const street = watch("street") || "";
//     const suffix = watch("suffix") || "";
//     const direction2 = watch("direction2") || "";
//     const city = watch("city") || "";
//     const state = watch("state") || "";
//     const zip = watch("zip") || "";

//     return `${direction1} ${addressNumber} ${street} ${suffix} ${direction2}, ${city}, ${state} ${zip}`.trim();
//   };
...
import Box from "@mui/material/Box";
import Button from "@mui/material/Button";
import CustomStepper from "@/components/Stepper"; // ✅ use your custom one
...
export default function FormPage() {
  ...
  return (
    <div className="flex flex-col items-center p-6">
      {/* ✅ Custom Stepper */}
      <CustomStepper steps={[1, 2, 3, 4, 5]} activeStep={activeStep} />

      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full max-w-2xl bg-white p-6 rounded-xl shadow-md"
      >
        {/* Example Fields (add yours as needed) */}
        <div className="mb-4">
          ...
          />
          {errors.fName && <p className="text-red-500">First name required</p>}
        </div>
